...
export const usuarioSlice = createSlice({
	...
	reducers: {
			...
			const citasUnidas = listaCitas.reduce((acumulador, citaActual) => {
				...
				if (!citaExistente) {
					...
					const nuevaCita = {
						...
						idtecnico: citaActual.idtecnico,
						nombreProductor: citaActual.nombreProductor,
						nombretecnico: citaActual.nombretecnico,
						ap_paternotecnico: citaActual.ap_paternotecnico,
						servicios: [
							{
		...
		// = = = = = = = = = = = = = = = = CITAS DE tecnico = = = = = = = = = = = = = = = =
		SET_CITAS_tecnico: (state, action) => {
			const citas = action.payload
			...
			state.citastecnico = citasUnidas
		},
		UPDATE_CITAS_tecnico: (state, action) => {
			const [idCita, updates] = action.payload
			state.citastecnico = state.citastecnico.map(cita => {
				if (cita.idCita == idCita) {
					return {
						...cita,
						...updates,
